...
import com.smoothalgo.benef.config.audit.AuditEventConverter;
import com.smoothalgo.benef.domain.PersistentAuditEvent;
...
import static com.smoothalgo.benef.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
